...
const OfficeScholarshipStatus3 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.officeScholarshipStatus3}>
      <Image
        style={styles.officeScholarshipStatus3Child}
        resizeMode="cover"
      ...
      <View style={styles.officeScholarshipStatus3Item} />
      <View
        style={[
          styles.officeScholarshipStatus3Inner,
          styles.rectangleViewShadowBox,
        ]}
      />
      <Image
        style={styles.nspschemesellogo1Icon}
        resizeMode="cover"
        source={require("../assets/nspschemesellogo-1.png")}
      />
      <Text style={styles.nationalScholarship}>National Scholarship</Text>
      <Image
...
export default OfficeScholarshipStatus3;
